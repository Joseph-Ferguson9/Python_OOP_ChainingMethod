...
joseph.make_deposit(1400).make_deposit(55).make_deposit(800).make_withdrawal(700).display_user_balance()
...
rydder.make_deposit(1400).make_deposit(500).make_withdrawal(3000).make_withdrawal(20).display_user_balance()
...
derek.make_deposit(1400).make_withdrawal(300).make_withdrawal(100).make_withdrawal(400).display_user_balance()
